...
public class ScanNetwork {
	...
	public static String[] checkHostsAtPort(int port) {
		...
		String[] hostsString = new String[(openHosts.size() == 0) ? 1
				: openHosts.size()];
		hostsString = openHosts.toArray(hostsString);

		if (hostsString.length == 1 && hostsString[0] == null)
			hostsString[0] = "localhost";
	...
	public static String[] addRecentServers(String[] scannedIPS,
		...
		ArrayList<String> recentList = FileList.getFileList(folderPath
				+ "recentServers");
