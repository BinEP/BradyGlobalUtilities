...
public class ChatRoomWindow extends JFrame {
 ...
 public static void newChat(String host) {
    ...
    private class ChatClient extends Client {
        ...
        protected void messageReceived(Object message) {
            if (message instanceof ForwardedMessage) {  // (no other message types are expected)
                ...
                String chatMessage = (String) bm.message;
                
                ChatCensor scanString = new ChatCensor(chatMessage);
                
                	System.out.println(chatMessage);
                	chatMessage = scanString.censorString();
//                	chatMessage = scanString.getCensoredString();
                	System.out.println(chatMessage);
                	
                
                addToTranscript("#" + bm.senderID + " SAYS:  " + chatMessage);
            }
        }
